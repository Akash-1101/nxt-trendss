...
class AllProductsSection extends Component {
  ...
  getProducts = async () => {
    ...
    if (response.ok === true && fetchedData.products.length === 0) {
      this.setState({isLoading: false, apiStatus: 'NoProducts'})
    }
  }
    ...
    return (
      <div className="all-products-section">
        ...
        <FiltersGroup
          ...
          onTapCategory={this.onTapCategory}
          onTapStars={this.onTapStars}
          onTapClear={this.onTapClear}
